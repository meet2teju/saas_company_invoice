            ...
            <div class="content content-two">
                ...
                <div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
                    ...
                    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
                        ...
                        <div>
                            <a href="add-purchases.php" class="btn btn-primary d-flex align-items-center"><i class="isax isax-add-circle5 me-1"></i>New Purchase</a>
                        </div>
                    </div>
                </div>
                <!-- End Page Header -->
                            ...
                            <tr>
                                ...
                                <td class="action-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="edit-purchases.php" class="dropdown-item d-flex align-items-center"><i class="isax isax-edit me-2"></i>Edit</a>
                                        </li>
                                        <li>
                ...
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="purchases.php" class="btn btn-primary">Yes, Delete</a>
                        </div>
					</div><!-- End modal body-->
