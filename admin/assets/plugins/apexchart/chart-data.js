...
//     series: [
//       { name: 'Paid', data: typeof paidAmounts !== 'undefined' ? paidAmounts : [] },
//       { name: 'Unpaid', data: typeof unpaidAmounts !== 'undefined' ? unpaidAmounts : [] }
//     ],
//     grid: {
//       borderColor: '#E2E4E6',
//       strokeDashArray: 5,
...
//     // Example dynamic data; replace these with your actual amounts
//     var invoicedAmount = 505000;
//     var receivedAmount = 252500;
//     var pendingAmount = 252500; // unpaid should be yellow

//     // Calculate percentages
//     var total = invoicedAmount + receivedAmount + pendingAmount;
//     var invoicedPercent = total ? (invoicedAmount / total * 100).toFixed(1) : 0;
//     var receivedPercent = total ? (receivedAmount / total * 100).toFixed(1) : 0;
//     var pendingPercent = total ? (pendingAmount / total * 100).toFixed(1) : 0;

//     var options = {
//         series: [
//             parseFloat(invoicedPercent),
//             parseFloat(receivedPercent),
//             parseFloat(pendingPercent)
//         ],
//         chart: {
//             type: 'donut',
//             height: 240,
...
//         colors: ['#2F80ED', '#27AE60', '#E2B93B'], // blue, green, yellow
//         plotOptions: {
//             pie: {
//                 donut: {
//                     size: '70%',
...
//             position: "bottom",
//             labels: {
//                 colors: ['#2F80ED', '#27AE60', '#E2B93B'] // match legend colors
//             }
//         }
//     };
