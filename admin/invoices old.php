...
// Get invoice data with filters applied
...
$totalinvoice = "SELECT SUM(total_amount) AS total_invoices FROM invoice WHERE is_deleted = 0";
...
// Query to get the total sum of all paid invoices
$sql_paid = "SELECT SUM(total_amount) AS total_paid_invoices FROM invoice WHERE status = 'Paid' AND is_deleted = 0";
...
// Query to get the total sum of all pending invoices
$sql_pending = "SELECT SUM(total_amount) AS total_pending_invoices FROM invoice WHERE status = 'unpaid' AND is_deleted = 0";
...
// Query to get the total sum of all overdue invoices
$sql_overdue = "SELECT SUM(total_amount) AS total_overdue_invoices FROM invoice WHERE status = 'Overdue' AND is_deleted = 0";
                        ...
                        <div class="table-responsive">
                            <table class="table table-nowrap datatable">
                                ...
                                <tbody>
                                    ...
                                    FROM invoice i 
                                    LEFT JOIN client c ON i.client_id = c.id 
                                    WHERE i.status = 'cancelled' AND i.is_deleted = 0 
                                    ORDER BY i.id DESC";
                        ...
                        <div class="table-responsive">
                            <table class="table table-nowrap datatable">
                                ...
                                <tbody>
                                    ...
                                    FROM invoice i 
                                    LEFT JOIN client c ON i.client_id = c.id 
                                    WHERE i.status = 'unpaid' AND i.is_deleted = 0 
                                    ORDER BY i.id DESC";
                        ...
                        <div class="table-responsive">
                            <table class="table table-nowrap datatable">
                                ...
                                <tbody>
                                    ...
                                    FROM invoice i 
                                    LEFT JOIN client c ON i.client_id = c.id 
                                    WHERE i.status = 'draft' AND i.is_deleted = 0 
                                    ORDER BY i.id DESC";
