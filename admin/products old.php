...
<?php endif; ?>
			...
			<div class="content content-two">
				...
				<div class="mb-3">
					<div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
						<div class="d-flex align-items-center flex-wrap gap-2">
                            ...
                            <?php
                                $filtersApplied = !empty($_GET['product']) || 
                                                !empty($_GET['category']) || 
                                                !empty($_GET['unit']) || 
                                                (isset($_GET['status']) && $_GET['status'] !== '');
                                ?>
                                <a href="products.php" class="btn btn-outline-secondary <?= $filtersApplied ? '' : 'd-none' ?>">
                ...
                <table class="table table-nowrap datatable">
                    ...
                    // $query = "SELECT 
                    //             p.id, p.code, p.name, p.quantity, p.selling_price, p.purchase_price, p.product_img,
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td class="action-item">
                                ...
                                <li>
                                    <a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#deleteModal<?= $productId ?>">
