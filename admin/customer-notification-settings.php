                                            ...
                                            <div class="sidebar-inner">
                                                <div class="sidebar-menu p-0">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="customer-notifications-settings.php" class="active fs-14 fw-medium d-flex align-items-center"><i class="isax isax-notification fs-18 me-1"></i>Notifications</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
