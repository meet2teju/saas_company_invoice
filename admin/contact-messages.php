            ...
            <div class="content content-two">
                ...
                <div class="mb-3">
                    ...
                    <div class="align-items-center gap-2 flex-wrap filter-info mt-3">
                        ...
                        <span class="tag bg-light border rounded-1 fs-12 text-dark badge"><span class="num-count d-inline-flex align-items-center justify-content-center bg-success fs-10 me-1">5</span>Name Selected<span class="ms-1 tag-close"><i class="fa-solid fa-x fs-10"></i></span></span>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="action-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="contact-message.php" class="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#edit_modal"><i class="isax isax-edit me-2"></i>Edit</a>
                                        </li>
                                        <li>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                            <img src="assets/img/users/user-35.jpg" class="rounded-circle" alt="img">
                                        </a>
                                        <div>
        ...
        <div id="edit_modal" class="modal fade">
            <div class="modal-dialog modal-dialog-centered modal-lg edit-contact-modal">
                <div class="modal-content">
                    ...
                    <form action="contact-message.php">
                ...
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="contact-message.php" class="btn btn-primary">Yes, Delete</a>
                        </div>
                    </div>
                </div>
            </div>
